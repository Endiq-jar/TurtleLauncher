...
class ExperimentalSettingsFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // "Client Settings" — same switches, same AllSettings values, duplicated here per user
        // request so every HUD module is also reachable from one dedicated section. Each pair
        // is kept in sync manually since they're two separate Switch views bound to the same
        // underlying setting.
        fun mirror(a: android.widget.Switch, b: android.widget.Switch) {
            b.isChecked = a.isChecked
            a.setOnCheckedChangeListener { _, checked -> b.isChecked = checked }
            b.setOnCheckedChangeListener { _, checked -> a.isChecked = checked }
        }
        SwitchSettingsWrapper(context, AllSettings.showCpsHud, binding.clientShowCpsHudLayout, binding.clientShowCpsHud)
        SwitchSettingsWrapper(context, AllSettings.showKeystrokesHud, binding.clientShowKeystrokesHudLayout, binding.clientShowKeystrokesHud)
        SwitchSettingsWrapper(context, AllSettings.showMousestrokesHud, binding.clientShowMousestrokesHudLayout, binding.clientShowMousestrokesHud)
        SwitchSettingsWrapper(context, AllSettings.showStopwatchHud, binding.clientShowStopwatchHudLayout, binding.clientShowStopwatchHud)
        SwitchSettingsWrapper(context, AllSettings.showPlaytimeHud, binding.clientShowPlaytimeHudLayout, binding.clientShowPlaytimeHud)
        SwitchSettingsWrapper(context, AllSettings.showSystemResourcesHud, binding.clientShowSystemResourcesHudLayout, binding.clientShowSystemResourcesHud)
        SwitchSettingsWrapper(context, AllSettings.showTimeHud, binding.clientShowTimeHudLayout, binding.clientShowTimeHud)
        SwitchSettingsWrapper(context, AllSettings.showRamGraphHud, binding.clientShowRamGraphHudLayout, binding.clientShowRamGraphHud)
        SwitchSettingsWrapper(context, AllSettings.showPingHud, binding.clientShowPingHudLayout, binding.clientShowPingHud)
        SwitchSettingsWrapper(context, AllSettings.showScreenshotButtonHud, binding.clientShowScreenshotButtonHudLayout, binding.clientShowScreenshotButtonHud)
        mirror(binding.showCpsHud, binding.clientShowCpsHud)
        mirror(binding.showKeystrokesHud, binding.clientShowKeystrokesHud)
        mirror(binding.showMousestrokesHud, binding.clientShowMousestrokesHud)
        mirror(binding.showStopwatchHud, binding.clientShowStopwatchHud)
        mirror(binding.showPlaytimeHud, binding.clientShowPlaytimeHud)
        mirror(binding.showSystemResourcesHud, binding.clientShowSystemResourcesHud)
        mirror(binding.showTimeHud, binding.clientShowTimeHud)
        mirror(binding.showRamGraphHud, binding.clientShowRamGraphHud)
        mirror(binding.showPingHud, binding.clientShowPingHud)
        mirror(binding.showScreenshotButtonHud, binding.clientShowScreenshotButtonHud)
