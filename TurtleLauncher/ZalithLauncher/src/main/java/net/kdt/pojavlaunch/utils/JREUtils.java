...
public final class JREUtils {
    ...
    private static void setRendererEnv(Map<String, String> envMap) {
        ...
        // Only Zink-family renderers should force the Zink driver override / Mesa
        // compat flags; opengles/GL4ES/MobileGlues/ANGLE renderers need neither.
        boolean isZinkRenderer = rendererId.toLowerCase().contains("zink");
        ...
        if (isZinkRenderer) {
            ...
            // Non-opengles, non-zink renderers (VirGL, Freedreno, Panfrost, etc.)
            // still need their cache dir and compat flags, just not the Zink override.
            envMap.put("MESA_GLSL_CACHE_DIR", PathManager.DIR_CACHE.getAbsolutePath());
            envMap.put("force_glsl_extensions_warn", "true");
            envMap.put("allow_higher_compat_version", "true");
            envMap.put("allow_glsl_extension_directive_midshader", "true");
