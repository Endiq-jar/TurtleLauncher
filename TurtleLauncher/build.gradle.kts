...
dependencies {
    ...
    // :TurtleLauncher:checkDebugDuplicateClasses with "Duplicate class com.google.gson.Gson
    ...
    // in, and also deleted. They broke :TurtleLauncher:processDebugMainManifest outright:
    //
