...
val turtlePackageName = "com.endiq.turtlelauncher"
...
android {
    ...
    signingConfigs {
        create("releaseBuild") {
            storeFile = file("turtle_launcher.jks")
        ...
        create("debugBuild") {
            storeFile = file("turtle_launcher_debug.jks")
    ...
    defaultConfig {
        applicationId = turtlePackageName
        minSdk = 26
        targetSdk = 34
