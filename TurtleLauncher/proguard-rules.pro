...
-keep class com.endiq.turtlelauncher.bridge.** { *; }
-keep class com.endiq.turtlelauncher.utils.device.VulkanChecker {
    *;
}
-keep class com.endiq.turtlelauncher.utils.device.VulkanCapabilities {
    *;
}
-keep interface com.endiq.turtlelauncher.utils.device.VulkanLogCallback {
    *;
}
-keep class com.endiq.turtlelauncher.game.input.CriticalNativeTest {
    *;
}
