...
import com.endiq.turtlelauncher.utils.string.getStringNotNull
import java.io.File
...
class VersionConfig(
    ...
    fun saveWithThrowable() {
        ...
        val configFile = File(turtleVersionPath, "version.config")
    ...
    companion object CREATOR : Parcelable.Creator<VersionConfig> {
        ...
        fun parseConfig(versionPath: File): VersionConfig {
            val configFile = File(getTurtleVersionPath(versionPath), "version.config")
