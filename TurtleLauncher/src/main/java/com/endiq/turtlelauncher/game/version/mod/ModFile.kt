...
import com.endiq.turtlelauncher.game.download.assets.platform.ModLoaderDisplayLabel
import com.endiq.turtlelauncher.game.download.assets.platform.Platform
import kotlinx.parcelize.Parcelize

/**
 * The mod's corresponding file on the platform
 * @param id the file ID
 * @param platform Owning platform
 * @param datePublished the publish date
 */
@Parcelize
class ModFile(
    val id: String,
