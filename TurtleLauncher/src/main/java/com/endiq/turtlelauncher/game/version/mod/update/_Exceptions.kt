...
/**
 * Thrown as [ModUpdateCancelledException] to abort the task when the user cancels while confirming mod updates
 */
class ModUpdateCancelledException : RuntimeException("Update cancelled by user")

/**
 * [NoModUpdatesAvailableException] is thrown when every mod is up to date and nothing needs updating
 */
