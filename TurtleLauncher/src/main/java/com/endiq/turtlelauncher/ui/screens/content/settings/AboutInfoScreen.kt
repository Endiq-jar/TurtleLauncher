...
import com.endiq.turtlelauncher.game.plugin.appCacheIcon
import com.endiq.turtlelauncher.library.LibraryInfo
import com.endiq.turtlelauncher.library.libraryData
            ...
            animatedItem(scope) { yOffset ->
                ChunkLayout(
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                        ...
                        ButtonIconItem(
                            icon = painterResource(R.drawable.img_avatar_endiq),
                            title = stringResource(R.string.about_launcher_author_endiq_title),
