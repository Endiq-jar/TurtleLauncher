 ...
 * ShareLogsFragment's "Upload to mclo.gs" action. Mirrors [com.endiq.zalithlauncher.feature.mod.ModrinthDirectApi]'s
...
object MclogsUploader {
     ...
     * Blocking - call from a background thread (e.g. via [com.endiq.zalithlauncher.task.Task]).
     */
