package com.endiq.zalithlauncher.feature.mod.modloader
...
import com.endiq.zalithlauncher.feature.mod.modloader.NeoForgeUtils.Companion.getNeoForgeInstallerUrl
import com.endiq.zalithlauncher.feature.mod.modloader.NeoForgeUtils.Companion.getNeoForgedForgeInstallerUrl
...
class NeoForgeDownloadTask(neoforgeVersion: String) : InstallTask, DownloaderFeedback {
    ...
    override fun run(customName: String): File? {
        ...
        if (if (mLoaderVersion?.contains("1.20.1") == true) determineNeoForgedForgeDownloadUrl() else determineNeoForgeDownloadUrl()) {
