...
public class TerracottaVpnService extends VpnService {
    ...
    public static final String ACTION_START = "com.endiq.zalithlauncher.terracotta.action.START";
    public static final String ACTION_STOP = "com.endiq.zalithlauncher.terracotta.action.STOP";
