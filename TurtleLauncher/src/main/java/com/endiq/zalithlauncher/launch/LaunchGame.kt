...
import com.endiq.zalithlauncher.feature.mod.NanoVGNativesFix
...
import com.endiq.zalithlauncher.support.touch_controller.ControllerProxy
import com.endiq.zalithlauncher.task.TaskExecutors
import com.endiq.zalithlauncher.ui.dialog.LifecycleAwareTipDialog
        ...
        fun preLaunch(context: Context, version: Version) {
            ...
            runCatching {
                val loader = version.getVersionInfo()?.loaderInfo?.firstNotNullOfOrNull {
                    com.endiq.zalithlauncher.feature.download.utils.ModLoaderUtils.getModLoader(it.name)
                }
            ...
            runCatching {
                ...
                val catalogEntry = com.endiq.zalithlauncher.renderer.RendererCatalog.get(rendererId)
