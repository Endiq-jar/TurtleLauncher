package com.endiq.zalithlauncher.plugins.feature
 ...
 * [com.endiq.zalithlauncher.plugins.renderer.RendererPluginManager] /
 * [com.endiq.zalithlauncher.plugins.driver.DriverPluginManager] - same
 * `queryIntentActivities(MAIN)` scan already run by [com.endiq.zalithlauncher.plugins.PluginLoader],
...
object FeaturePluginManager {
     ...
     * MAIN/DEFAULT activity [com.endiq.zalithlauncher.plugins.PluginLoader] already finds
