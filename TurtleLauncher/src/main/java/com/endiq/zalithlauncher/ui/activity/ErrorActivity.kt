package com.endiq.zalithlauncher.ui.activity
...
import com.endiq.zalithlauncher.databinding.ActivityErrorBinding
import com.endiq.zalithlauncher.feature.log.CrashAnalyzer
import com.endiq.zalithlauncher.feature.log.GameLogcat
import com.endiq.zalithlauncher.feature.log.Logging
import com.endiq.zalithlauncher.feature.log.SelfHealingManager
...
class ErrorActivity : BaseActivity() {
     ...
     */
    private fun runSelfHeal(diagnoses: List<CrashAnalyzer.Diagnosis>, gameVersion: com.endiq.zalithlauncher.feature.version.Version?) {
    ...
    private fun runRepair(action: CrashAnalyzer.RepairAction, gameVersion: com.endiq.zalithlauncher.feature.version.Version?) {
    ...
    private fun exportDiagnostics(diagnoses: List<CrashAnalyzer.Diagnosis>, gameVersion: com.endiq.zalithlauncher.feature.version.Version?) {
    ...
    companion object {
        ...
        /**
         * @param diagnosis optional pre-formatted [com.endiq.zalithlauncher.feature.log.CrashAnalyzer]
