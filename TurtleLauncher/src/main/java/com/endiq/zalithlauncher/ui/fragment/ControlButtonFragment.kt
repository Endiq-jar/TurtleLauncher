...
import com.endiq.zalithlauncher.databinding.FragmentControlManagerBinding
...
import com.endiq.zalithlauncher.ui.dialog.EditControlInfoDialog
...
import com.endiq.zalithlauncher.ui.subassembly.customcontrols.ControlInfoData
import com.endiq.zalithlauncher.ui.subassembly.customcontrols.ControlSelectedListener
import com.endiq.zalithlauncher.ui.subassembly.customcontrols.ControlsListViewCreator
import com.endiq.zalithlauncher.ui.subassembly.customcontrols.EditControlData.Companion.createNewControlFile
...
class ControlButtonFragment : FragmentWithAnim(R.layout.fragment_control_manager) {
    ...
    override fun slideIn(animPlayer: AnimPlayer) {
        animPlayer.apply(AnimPlayer.Entry(binding.controlLayout, TurtleTransitions.enter()))
            .apply(AnimPlayer.Entry(binding.operateLayout, TurtleTransitions.enter()))
    }

    override fun slideOut(animPlayer: AnimPlayer) {
        animPlayer.apply(AnimPlayer.Entry(binding.controlLayout, TurtleTransitions.exit()))
