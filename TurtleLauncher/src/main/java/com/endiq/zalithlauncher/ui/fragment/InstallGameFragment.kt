...
import com.endiq.zalithlauncher.databinding.FragmentInstallGameBinding
import com.endiq.zalithlauncher.event.sticky.SelectInstallTaskEvent
...
import com.endiq.zalithlauncher.feature.version.install.ExtraModInstall
import com.endiq.zalithlauncher.feature.version.install.InstallArgsUtils
...
import com.endiq.zalithlauncher.ui.dialog.InstallExtrasDialog
import com.endiq.zalithlauncher.ui.dialog.TipDialog
import com.endiq.zalithlauncher.ui.fragment.download.addon.DownloadFabricApiFragment
import com.endiq.zalithlauncher.ui.fragment.download.addon.DownloadFabricFragment
import com.endiq.zalithlauncher.ui.fragment.download.addon.DownloadForgeFragment
import com.endiq.zalithlauncher.ui.fragment.download.addon.DownloadCleanroomFragment
import com.endiq.zalithlauncher.ui.fragment.download.addon.DownloadNeoForgeFragment
import com.endiq.zalithlauncher.ui.fragment.download.addon.DownloadOptiFineFragment
import com.endiq.zalithlauncher.ui.fragment.download.addon.DownloadQuiltApiFragment
import com.endiq.zalithlauncher.ui.fragment.download.addon.DownloadQuiltFragment
            ...
            when (v) {
                ...
                modpackLayout -> {
                    val bundle = android.os.Bundle().apply {
                        putInt(com.endiq.zalithlauncher.ui.fragment.DownloadFragment.ARG_INITIAL_TAB, 1) // ModPack tab
                        putString(com.endiq.zalithlauncher.ui.fragment.DownloadFragment.ARG_INITIAL_QUERY, FEATURED_MODPACK_QUERY)
                    }
                    ZHTools.swapFragmentWithAnim(this@InstallGameFragment, com.endiq.zalithlauncher.ui.fragment.DownloadFragment::class.java,
                        com.endiq.zalithlauncher.ui.fragment.DownloadFragment.TAG, bundle)
                }
