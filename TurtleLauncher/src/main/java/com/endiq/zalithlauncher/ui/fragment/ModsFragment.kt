...
import com.endiq.zalithlauncher.databinding.FragmentModsBinding
import com.endiq.zalithlauncher.feature.download.enums.ModLoader
import com.endiq.zalithlauncher.feature.download.utils.ModLoaderUtils
import com.endiq.zalithlauncher.feature.mod.ModToggleHandler
import com.endiq.zalithlauncher.feature.mod.ModUtils
import com.endiq.zalithlauncher.feature.mod.RecommendedContentInstaller
...
import com.endiq.zalithlauncher.ui.dialog.FilesDialog
import com.endiq.zalithlauncher.ui.dialog.FilesDialog.FilesButton
...
import com.endiq.zalithlauncher.ui.subassembly.filelist.FileSelectedListener
import com.endiq.zalithlauncher.ui.subassembly.view.SearchViewWrapper
import com.endiq.zalithlauncher.utils.NewbieGuideUtils
import com.endiq.zalithlauncher.utils.ZHTools
import com.endiq.zalithlauncher.utils.anim.AnimUtils.Companion.setVisibilityAnim
import com.endiq.zalithlauncher.utils.file.FileCopyHandler
import com.endiq.zalithlauncher.utils.file.FileTools
import com.endiq.zalithlauncher.utils.file.PasteFile
...
class ModsFragment : FragmentWithAnim(R.layout.fragment_mods) {
    ...
    private fun confirmInstallRecommended() {
        ...
        TipDialog.Builder(context)
            ...
            .setMessage(
                "Fabric API, Sodium, Lithium, Entity Culling, Indium (if needed), FerriteCore, " +
                "ModernFix, ImmediatelyFast, and the Bare Bones resource pack — matched to " +
                "Minecraft $mcVersion${loader?.let { " / ${it.loaderName}" } ?: ""}. " +
                "Anything not built for this loader is skipped automatically."
            )
            .setShowCancel(true)
    ...
    override fun slideOut(animPlayer: AnimPlayer) {
        binding.apply {
            animPlayer.apply(AnimPlayer.Entry(modsLayout, TurtleTransitions.exit()))
