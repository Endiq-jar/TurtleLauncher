...
import com.endiq.zalithlauncher.databinding.FragmentVersionConfigBinding
...
import com.endiq.zalithlauncher.feature.version.NoVersionException
import com.endiq.zalithlauncher.feature.version.Version
import com.endiq.zalithlauncher.feature.version.VersionConfig
import com.endiq.zalithlauncher.feature.version.VersionConfig.CREATOR.getIsolationString
import com.endiq.zalithlauncher.feature.version.VersionConfig.IsolationType
import com.endiq.zalithlauncher.feature.version.VersionsManager.getCurrentVersion
...
import com.endiq.zalithlauncher.setting.AllSettings.Companion.versionIsolation
import com.endiq.zalithlauncher.task.Task
import com.endiq.zalithlauncher.task.TaskExecutors.Companion.getAndroidUI
...
import com.endiq.zalithlauncher.utils.file.FileTools.Companion.copyFileInBackground
...
class VersionConfigFragment : FragmentWithAnim(R.layout.fragment_version_config), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            cpuCoreOverrideEdit.doAfterTextChanged { text ->
                val cores = getEditableValue(text).toIntOrNull()
                mTempConfig?.setCpuCoreOverride(if (cores == null || cores <= 0) -1 else cores)
            }
    ...
    private fun loadValues(context: Context) {
        mTempConfig?.let { config ->
            binding.apply {
                ...
                // A javaDir that doesn't carry the "pojav://" prefix (legacy config,
