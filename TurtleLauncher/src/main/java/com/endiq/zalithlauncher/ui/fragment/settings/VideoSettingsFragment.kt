...
import com.endiq.zalithlauncher.databinding.SettingsFragmentVideoBinding
import com.endiq.zalithlauncher.event.single.LauncherIgnoreNotchEvent
...
import com.endiq.zalithlauncher.renderer.renderers.MobileGluesRenderer
...
import com.endiq.zalithlauncher.ui.dialog.LocalRendererPluginDialog
...
class VideoSettingsFragment : AbstractSettingsFragment(R.layout.settings_fragment_video, SettingCategory.VIDEO) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rendererManagerButton.setOnClickListener {
            ZHTools.swapFragmentWithAnim(this, com.endiq.zalithlauncher.ui.fragment.settings.RendererManagerFragment::class.java, com.endiq.zalithlauncher.ui.fragment.settings.RendererManagerFragment.TAG, null)
        }
        ...
        binding.resolutionAutoDetectButton.setOnClickListener {
            com.endiq.zalithlauncher.launch.AutoSettingsOptimizer.apply(context)
