package com.endiq.zalithlauncher.ui.subassembly.account;
...
import com.endiq.zalithlauncher.databinding.ItemAccountManagerBinding;
...
public class AccountAdapter extends RecyclerView.Adapter<AccountAdapter.Holder> {
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public void setData(MinecraftAccount account) {
            ...
            try {
                binding.icon.setImageDrawable(SkinLoader.getAvatarDrawable(mContext, account, mContext.getResources().getDimensionPixelSize(R.dimen._38sdp)));
            } catch (Exception e) {
