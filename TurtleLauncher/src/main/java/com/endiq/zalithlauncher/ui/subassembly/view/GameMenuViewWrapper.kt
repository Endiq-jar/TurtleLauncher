package com.endiq.zalithlauncher.ui.subassembly.view
...
import com.endiq.zalithlauncher.feature.inputstats.InputStatsTracker
import com.endiq.zalithlauncher.feature.inputstats.SessionStatsTracker
import com.endiq.zalithlauncher.setting.AllSettings
import com.endiq.zalithlauncher.task.TaskExecutors
import com.endiq.zalithlauncher.utils.NewbieGuideUtils
import com.endiq.zalithlauncher.utils.file.FileTools.Companion.formatFileSize
import com.endiq.zalithlauncher.utils.platform.MemoryUtils
...
class GameMenuViewWrapper(
    ...
    private fun thinkForHudVisibility() {
        val shouldShow = showMemory || showFPS || showCps || showKeystrokes || showMousestrokes ||
            ...
            showRamGraph || showPing || showScreenshotButton || showRecordButton
    ...
    private fun refreshState() {
        ...
        showNativeMemory = AllSettings.gameMenuShowNativeMemory.getValue()
        ...
        showRecordButton = AllSettings.showRecordButtonHud.getValue()
    }
    ...
    private fun updateInfoText(view: View) {
        ...
        val ramGraphView: com.endiq.zalithlauncher.feature.turtle.RamGraphView = view.findViewById(R.id.ram_graph_view)
        val screenshotButton: TextView = view.findViewById(R.id.screenshot_button)
        val recordButton: TextView = view.findViewById(R.id.record_button)
        val recordTimerText: TextView = view.findViewById(R.id.record_timer_text)
        ...
        fun updateInfoText() {
            ...
            if (showPing) {
                val ms = com.endiq.zalithlauncher.feature.turtle.PingTracker.getPingMs()
            ...
            if (showRecordButton) {
                val recording = com.endiq.zalithlauncher.feature.turtle.ScreenRecorder.isRecording()
                TaskExecutors.runInUIThread {
                    ...
                    if (recording && AllSettings.recordingShowTimer.getValue()) {
                        val elapsed = com.endiq.zalithlauncher.feature.turtle.ScreenRecorder.getElapsedSeconds()
        ...
        if (showInfo) {
            ...
            screenshotButton.setOnClickListener {
                com.endiq.zalithlauncher.feature.turtle.ScreenshotHelper.takeScreenshot(activity)
            }
            if (!showRecordButton) {
            ...
            recordButton.setOnClickListener {
                com.endiq.zalithlauncher.feature.turtle.ScreenRecorder.toggle(activity)
            }

            if (showPing) {
                com.endiq.zalithlauncher.feature.turtle.PingTracker.start()
            }
