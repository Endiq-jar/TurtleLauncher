...
public class SDL {
    ...
    public static void loadLibrary(String libraryName, Context context) throws UnsatisfiedLinkError, SecurityException, NullPointerException {
        ...
        // TurtleLauncher: upstream DroidBridge Launcher calls its own
        // DroidBridgeSDL3NativeWindowBridge.installHook() here - a native (C-level)
        ...
        // Android Surface. That hook requires DroidBridge's own native library
        // (droidbridge_runtime.so) which isn't part of this codebase and can't be
