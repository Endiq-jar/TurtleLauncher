...
JNIEXPORT void JNICALL Java_com_endiq_turtlelauncher_bridge_TLBridge_setupBridgeWindow(JNIEnv* env, ABI_COMPAT jclass clazz, jobject surface) {
...
Java_com_endiq_turtlelauncher_bridge_TLBridge_releaseBridgeWindow(ABI_COMPAT JNIEnv *env, ABI_COMPAT jclass clazz) {
