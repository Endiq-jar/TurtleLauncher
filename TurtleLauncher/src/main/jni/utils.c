...
JNIEXPORT void JNICALL Java_com_endiq_turtlelauncher_bridge_TLBridge_setLdLibraryPath(JNIEnv *env, jclass clazz, jstring ldLibraryPath) {
...
JNIEXPORT jboolean JNICALL Java_com_endiq_turtlelauncher_bridge_TLBridge_dlopen(JNIEnv *env, jclass clazz, jstring name) {
...
JNIEXPORT jlong JNICALL Java_com_endiq_turtlelauncher_bridge_TLBridge_getJavaVMPointer(JNIEnv *env, jclass clazz) {
	if (pojav_environ->dalvikJavaVMPtr == NULL) return 0;
	return (jlong) (intptr_t) pojav_environ->dalvikJavaVMPtr;
}

JNIEXPORT jstring JNICALL Java_com_endiq_turtlelauncher_bridge_TLBridge_jObjectToString(JNIEnv *env, jclass clazz, jobject object) {
...
JNIEXPORT jint JNICALL Java_com_endiq_turtlelauncher_bridge_TLBridge_chdir(JNIEnv *env, jclass clazz, jstring nameStr) {
