...
#define TL_MAX_PATCH_VERSION 4095

JNIEXPORT void JNICALL
Java_com_endiq_turtlelauncher_utils_device_VulkanChecker_nativeSetLogCallback(
        JNIEnv *env,
        jclass clazz,
        jobject callback
) {
...
Java_com_endiq_turtlelauncher_utils_device_VulkanChecker_nativeCheckVulkan(
        JNIEnv *env,
        jclass clazz,
        jstring jDriverPath,
        jstring jNativeDir,
...
#undef PUT_FEAT
    ...
    jclass capClass = (*env)->FindClass(env, "com/endiq/turtlelauncher/utils/device/VulkanCapabilities");
