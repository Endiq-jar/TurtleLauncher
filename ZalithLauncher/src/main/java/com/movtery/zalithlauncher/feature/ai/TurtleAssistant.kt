package com.movtery.zalithlauncher.feature.ai
 ...
 * key ([com.movtery.zalithlauncher.feature.log.AiCrashAdvisor] for crash help and
 * [com.movtery.zalithlauncher.feature.skin.AiContentModerator] for skin filtering, both
...
object TurtleAssistant {
    ...
    private fun aboutAnswer(context: Context): String {
        val versions = runCatching { VersionsManager.getVersions() }.getOrDefault(emptyList())
        return "TurtleLauncher is a PojavLauncher/ZalithLauncher-family Minecraft: Java Edition " +
