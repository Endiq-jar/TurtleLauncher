...
interface RendererInterface {
     ...
     * (POJAV_RENDERER) - NOT necessarily the same as [getRendererId]. pojavexec.so is
     * built from source in this repo (jni/Android.mk -> jni/egl_bridge.c) and its
     * pojavInitOpenGL() has a hardcoded, pre-FCL-refactor set of recognized
     * POJAV_RENDERER strings (see Renderers.kt's top-of-file doc comment for the full
     * mapping table). A string it
