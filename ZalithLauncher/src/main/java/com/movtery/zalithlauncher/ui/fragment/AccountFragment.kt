...
class AccountFragment : FragmentWithAnim(R.layout.fragment_account), View.OnClickListener {
    ...
    private fun updateAccountDetail() {
        ...
        binding.viewAccountDetail.apply {
            ...
            runCatching {
                val bitmap = com.movtery.zalithlauncher.utils.skin.SkinLoader.getSkinBitmap(requireContext(), account)
    ...
    override fun onStart() {
        ...
        (skinPreviewView ?: binding.viewAccountDetail.detailSkinPreview).onResume()
    }

    override fun onStop() {
        super.onStop()
        EventBus.getDefault().unregister(this)
        (skinPreviewView ?: binding.viewAccountDetail.detailSkinPreview).onPause()
    }
