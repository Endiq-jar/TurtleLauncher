...
import com.movtery.zalithlauncher.feature.turtle.heatmap.PerfEstimate;
import com.movtery.zalithlauncher.feature.turtle.heatmap.PerfTier;
    ...
    public class InnerHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(FileItemBean fileItemBean, int position) {
            ...
            if (file != null && file.isFile() &&
                (file.getName().endsWith(com.movtery.zalithlauncher.feature.mod.ModUtils.JAR_FILE_SUFFIX) ||
                 file.getName().endsWith(com.movtery.zalithlauncher.feature.mod.ModUtils.DISABLE_JAR_FILE_SUFFIX))) {
                boolean enabled = file.getName().endsWith(com.movtery.zalithlauncher.feature.mod.ModUtils.JAR_FILE_SUFFIX);
                ...
                binding.modToggle.setOnCheckedChangeListener((btn, isChecked) -> {
                    if (isChecked) {
                        com.movtery.zalithlauncher.feature.mod.ModUtils.enableMod(file);
                    } else {
                        com.movtery.zalithlauncher.feature.mod.ModUtils.disableMod(file);
                    }
