...
import com.movtery.zalithlauncher.feature.version.ModpackExporter
import java.io.File
...
class VersionAdapter(
                ...
                FileDeletionHandler(
                    ...
                    Task.runTask {
                        ...
                        try {
                            ...
                            com.movtery.zalithlauncher.feature.log.Logging.e("VersionAdapter", "Refresh after delete failed", e)
                        }
                    }
                ).start()
            }.showDialog()
    ...
    private fun showDepGraph(context: Context, version: Version) {
        ...
        com.movtery.zalithlauncher.feature.mod.parser.ModParser.checkAllMods(
            version,
            object : com.movtery.zalithlauncher.feature.mod.parser.ModParserListener {
                override fun onProgress(recentlyParsedModInfo: com.movtery.zalithlauncher.feature.mod.parser.ModInfo, totalFileCount: Int) {}
                override fun onParseEnded(modList: List<com.movtery.zalithlauncher.feature.mod.parser.ModInfo>) {
                    TaskExecutors.runInUIThread {
                        dialog.dismiss()
                        val list = modList
