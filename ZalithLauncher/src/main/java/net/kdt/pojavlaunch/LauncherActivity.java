...
import com.movtery.zalithlauncher.ui.fragment.settings.SettingsFragment;
...
public class LauncherActivity extends BaseActivity {
        ...
        if (binding.storageButton != null && binding.storageButton.getVisibility() != android.view.View.GONE) {
            binding.storageButton.setOnClickListener(v -> {
                ...
                if (storageFragment != null) {
                    ...
                    bundle.putString(com.movtery.zalithlauncher.ui.fragment.FilesFragment.BUNDLE_LIST_PATH,
                        com.movtery.zalithlauncher.utils.path.PathManager.DIR_GAME_HOME);
                    ZHTools.swapFragmentWithAnim(storageFragment,
                        com.movtery.zalithlauncher.ui.fragment.FilesFragment.class,
                        com.movtery.zalithlauncher.ui.fragment.FilesFragment.TAG, bundle);
                }
            });
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == com.movtery.zalithlauncher.feature.terracotta.TerracottaVpnService.VPN_PERMISSION_REQUEST_CODE) {
            com.movtery.zalithlauncher.feature.terracotta.Terracotta.onVpnPermissionResult(this, resultCode == RESULT_OK);
        }
    }
    ...
    private void showWhatsNewIfNeeded() {
        ...
        if (!CURRENT_VERSION.equals(shownVersion)) {
            ...
            new com.movtery.zalithlauncher.ui.dialog.WhatsNewDialog(this).show();
        }
    }
}
