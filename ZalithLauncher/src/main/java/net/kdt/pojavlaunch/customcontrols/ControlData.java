...
public class ControlData {
    ...
    public static final int SPECIALBTN_CANCEL = -10;
    public static final int SPECIALBTN_EXIT = -11;
    ...
    public static ControlData[] getSpecialButtons(Context context) {
        if (SPECIAL_BUTTONS == null) {
            SPECIAL_BUTTONS = new ControlData[]{
                    ...
                    new ControlData(context.getString(R.string.keycode_special_cancel), new int[]{SPECIALBTN_CANCEL}, "${margin}", "${margin}"),
                    new ControlData(context.getString(R.string.keycode_special_exit), new int[]{SPECIALBTN_EXIT}, "${margin}", "${margin}")
            };
        }
