...
public class MainMenuFragment extends FragmentWithAnim {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.friendsLanButton.setOnClickListener(v -> android.widget.Toast.makeText(
            requireContext(),
            "Friends/LAN is temporarily disabled - working on a crash in the underlying library.",
