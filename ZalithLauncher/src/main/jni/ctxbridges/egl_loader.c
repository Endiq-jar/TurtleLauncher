...
const char* (*eglQueryString_p)(EGLDisplay dpy, EGLint name);
...
void dlsym_EGL() {
    ...
    eglQueryString_p = GLGetProcAddress(dl_handle, "eglQueryString");
    eglSurfaceAttrib_p = GLGetProcAddress(dl_handle, "eglSurfaceAttrib");
}
