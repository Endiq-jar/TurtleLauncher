...
public class GLFW
{
    ...
    private static long mGLFWMonitorUserPointer = 0L;
    ...
    /**
     * MC 26.x (com.mojang.blaze3d.platform.Monitor#queryMonitorName) calls this
     * directly on org.lwjgl.glfw.GLFW. It was missing from this stub, which made
     * every Minecraft 26.x launch crash with NoSuchMethodError during
     * MonitorManager init, regardless of which renderer (Freedreno/Panfrost/
     * VirGL/Zink/GL4ES) was selected.
     */
    @Nullable
    ...
    /** Newer GLFW API used by some MC 26.x / mod code; not present in upstream native GLFW on this build, stub it out safely. */
    ...
    public static void glfwSetWindowAspectRatio(@NativeType("GLFWwindow *") long window, int numer, int denom) {
        // No-op: aspect ratio locking isn't enforced on the Android surface.
    }

    public static void glfwIconifyWindow(@NativeType("GLFWwindow *") long window) {
        // No-op: there's no real desktop window manager to iconify on Android.
    }
